...
import com.orange.maven2bundle.installer.Resources;

public final class TResources {
	
	// location of the Maven repository for testing
	public final static String getLocalRepositoryLocation(){
		try {
			String mavenRepositoryLocation = Resources.getLocalRepositoryLocation();
			return mavenRepositoryLocation;
		} catch (Exception e) {
			System.out.println("... repository location set manually");
			return "/home/remi/.m2/repository/";
		}
	}
